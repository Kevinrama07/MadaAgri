/**
 * Message Queue - Gestion des messages offline (Mobile)
 * Stocke les messages en attente dans AsyncStorage et les renvoie à la reconnexion
 */
...
class MessageQueue {
  ...
  async processQueue(sendFunction) {
    ...
    for (const message of messages) {
      ...
      try {
        await this.markAsSending(message.id);
