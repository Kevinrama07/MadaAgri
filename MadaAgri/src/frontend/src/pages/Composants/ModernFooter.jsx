...
import styles from '../../styles/Composants/ModernFooter.module.css';

export default function ModernFooter() {
  return (
    <footer className={clsx(styles['modern-footer'])}>
      <div className={clsx(styles['footer-container'])}>
        <div className={clsx(styles['footer-content'])}>
          <div className={clsx(styles['footer-section'], styles['footer-branding'])}>
            <h3 className={clsx(styles['footer-logo'])}>MadaAgri</h3>
            <p className={clsx(styles['footer-description'])}>
              Connecter les agriculteurs de Madagascar et construire une agriculture durable.
            </p>
            <div className={clsx(styles['footer-social'])}>
              <a href="#" className={clsx(styles['social-link'])} aria-label="Facebook">
              ...
              <a href="#" className={clsx(styles['social-link'])} aria-label="Twitter">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="#" className={clsx(styles['social-link'])} aria-label="Instagram">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className={clsx(styles['footer-section'])}>
            <h4 className={clsx(styles['footer-section-title'])}>Ressources</h4>
            <ul className={clsx(styles['footer-links'])}>
              <li>
          ...
          <div className={clsx(styles['footer-section'])}>
            <h4 className={clsx(styles['footer-section-title'])}>Entreprise</h4>
            <ul className={clsx(styles['footer-links'])}>
              <li>
          ...
          <div className={clsx(styles['footer-section'])}>
            <h4 className={clsx(styles['footer-section-title'])}>Légal</h4>
            <ul className={clsx(styles['footer-links'])}>
              <li>
        ...
        <div className={clsx(styles['footer-bottom'])}>
          <p className={clsx(styles['footer-copyright'])}>
