...
import InvitationsCollaborateurs from './InvitationsCollaborateurs';
              ...
              {showEditModal && (
                <div className="mg-modal-overlay">
                  <div className="mg-modal-content mg-card">
                    ...
                    <label className="mg-input-label">
                      Localisation :
                      <select className="mg-input" value={regionId} onChange={(e) => setRegionId(e.target.value)} disabled={regionsLoading}>
